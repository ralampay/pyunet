...
class UNetAttnStackedGhostIrb(nn.Module):
    def __init__(
        ...
        self.conv2 = nn.Sequential(GhostConv(64, 128), InvertedResidualBlock(128, 128))
        self.conv3 = nn.Sequential(GhostConv(128, 256), InvertedResidualBlock(256, 256))
        self.conv4 = nn.Sequential(GhostConv(256, 512), InvertedResidualBlock(512, 512))
        self.conv5 = nn.Sequential(GhostConv(512, 1024), InvertedResidualBlock(1024, 1024))

        self.up5 = UpConv(1024, 512)
        self.attn5 = AttentionBlock(512, 512, 256)
        self.up_conv5 = nn.Sequential(GhostConv(1024, 512), InvertedResidualBlock(512, 512))

        self.up4 = UpConv(512, 256)
        self.attn4 = AttentionBlock(256, 256, 128)
        self.up_conv4 = nn.Sequential(GhostConv(512, 256), InvertedResidualBlock(256, 256))

        self.up3 = UpConv(256, 128)
        self.attn3 = AttentionBlock(128, 128, 64)
        self.up_conv3 = nn.Sequential(GhostConv(256, 128), InvertedResidualBlock(128, 128))

        self.up2 = UpConv(128, 64)
        self.attn2 = AttentionBlock(64, 64, 32)
        self.up_conv2 = nn.Sequential(GhostConv(128, 64), InvertedResidualBlock(64, 64))
